...
uint32_t ErrorM(uint32_t id)
  ...
  switch(id)
    {
    case 0:
    fprintf(stderr, "Usage: ./goose-fastqsimulation   [OPTION]... [FILE] \n\n");
    ...
    fprintf(stderr, " ./goose-fastqsimulation -v -t 1 -i n=MySeq -ld 30:80 -n "
    "20000 -qt=1 -qc 33,36,39:43 File\n");
    fprintf(stderr, " ./goose-fastqsimulation -v -ls 100 -n 10000 -eh -eo -es "
    "-edb -f 0.3,0.2,0.2,0.3,0.0 -rn 50 -ri 300 -ra 3000 -rm 0.1 File\n\n");
    break;

    case 1:
    fprintf(stderr, "For help, type: ./goose-fastqsimulation -h\n");
    break;
